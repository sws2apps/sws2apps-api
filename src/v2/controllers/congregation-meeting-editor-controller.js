...
export const updateVisitingSpeakers = async (req, res) => {
	const { id } = req.params;
...
export const findVisitingSpeakersCongregations = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const requestAccessSpeakersCongregation = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const getCongregationSpeakersRequests = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const getCongregationSpeakersRequestsStatus = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const approveCongregationSpeakersRequest = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const disapproveCongregationSpeakersRequest = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const getVisitingSpeakers = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const getApprovedVisitingSpeakersAccess = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const updateVisitingSpeakersAccess = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const sendPocketSchedule = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
