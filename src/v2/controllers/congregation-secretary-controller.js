...
export const getPendingFieldServiceReports = async (req, res) => {
	const { id } = req.params;
...
export const approvePendingFieldServiceReports = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
...
export const disapprovePendingFieldServiceReports = async (req, res) => {
	const { id } = req.params;
	const { uid } = req.headers;
