...
export const getAllCongregations = async (req, res) => {
...
export const deleteCongregation = async (req, res) => {
	const { id } = req.params;
...
export const addCongregationUserWithoutId = async (req, res) => {
...
export const updateCongregationUserRole = async (req, res) => {
	const { id } = req.params;
