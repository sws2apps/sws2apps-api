...
router.post("/announcement-save-draft", body("announcement").isObject(), saveAnnouncementDraft);
...
// publish announcement
router.post("/announcement-publish", body("announcement").isObject(), publishAnnouncementAdmin);
